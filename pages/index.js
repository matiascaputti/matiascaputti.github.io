      ...
      <div id="home">
        <div>
          <h1 ref={el => this.title = el}>
            <span ref={el => this.firstName = el}>
              Matías
            </span>

            <span ref={el => this.lastName = el}>
              Caputti
            </span>
          </h1>

          <h2 ref={el => this.description = el}>
            javascript <span>web / mobile</span> developer, ️
            <br />
            <span>data scientist</span> & deep learning enthusiast
            <br />
            <br />
